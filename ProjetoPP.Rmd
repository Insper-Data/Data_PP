...
base %>% 
  ...
  theme_clean() +
  labs(title = "Daily change in cumulative testing per thousand",
...
base %>% 
  select(name, iso_code, `WJP Rule of Law Index: Overall Score`, `Overall Score`, days_after_1pm, type) %>% 
...
### 12B) Previous analysis and the time variable "days_after_1pm"
