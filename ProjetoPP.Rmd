...
df2 <- t %>%
    ...
    # filter(country == "United States" & escala != "tests performed") %>% 
    # filter(country == "Singapore" & escala != "people tested") %>%
    # filter(country == "Poland" & escala != "people tested") %>%
    # filter(country == "Japan" & escala != "tests performed") %>%
    # filter(country == "Italy" & escala != "people tested") %>%
    # filter(country == "India" & escala != "people tested") %>%
    # filter(country == "France" & escala != "people tested")
