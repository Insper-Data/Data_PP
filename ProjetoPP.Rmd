...
reg5 <- lm(total_cases_per_million ~ `Overall Score` + `WJP Rule of Law Index: Overall Score` + gini_index_world_bank_estimate + population + gdp_per_capita + aged_65_older + median_age + population_density + Region + `Income Group` + human_development_index, data = b2)
